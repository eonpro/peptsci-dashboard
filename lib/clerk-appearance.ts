...
export const authAppearance = {
  ...
  elements: {
    ...
    socialButtonsBlockButton:
      '!h-12 !rounded-xl !border-0 !bg-white/[0.05] !text-white !shadow-[inset_0_0_0_1px_rgba(255,255,255,0.10)] transition-all duration-200 hover:!bg-white/[0.09] hover:!shadow-[inset_0_0_0_1px_rgba(255,255,255,0.20)]',
    ...
    formFieldInput:
      '!h-12 !rounded-xl !border-0 !bg-white/[0.05] !text-white !shadow-[inset_0_0_0_1px_rgba(255,255,255,0.10)] placeholder:!text-white/30 transition-all duration-200 focus:!bg-white/[0.07] focus:!shadow-[inset_0_0_0_1px_rgba(122,91,255,0.80)]',
    formFieldAction: '!text-[#8b95ff] hover:!text-white text-sm font-medium',
    formButtonPrimary:
      '!h-12 !rounded-xl !border-0 !bg-gradient-to-r !from-[#2342f0] !to-[#7a5bff] !text-white !text-[15px] !font-semibold !normal-case !tracking-normal !shadow-[0_12px_30px_-10px_rgba(67,76,255,0.7)] transition-all duration-200 hover:!brightness-110 hover:!shadow-[0_16px_38px_-8px_rgba(67,76,255,0.9)]',
    footer: 'hidden',
    identityPreviewText: '!text-white',
    identityPreviewEditButton: '!text-[#8b95ff] hover:!text-white',
    formResendCodeLink: '!text-[#8b95ff] hover:!text-white',
    otpCodeFieldInput:
      '!rounded-xl !border-0 !bg-white/[0.05] !text-white !shadow-[inset_0_0_0_1px_rgba(255,255,255,0.10)]',
    formFieldInputShowPasswordButton: '!text-white/40 hover:!text-white',
    alert: '!rounded-xl !border-0 !bg-white/[0.05] !shadow-[inset_0_0_0_1px_rgba(255,255,255,0.10)]',
