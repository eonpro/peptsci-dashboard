...
import { SMS_PROGRAM_NAME } from '@/lib/sms/program'
    ...
    <div className="space-y-6 pb-20 md:pb-8">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* SMS Preferences (TCPA / Twilio A2P consent — wording is the
          ...
          >
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-white/60">
                {SMS_PROGRAM_NAME} — text message notifications to the mobile number on file
            ...
            <CardContent className="space-y-3">
              <label className="flex items-start gap-3 cursor-pointer">
                <Checkbox
                  ...
                  disabled={smsSaving}
                  aria-describedby="sms-preferences-help"
                  className="mt-0.5 border-white/30 data-[state=checked]:bg-brand-primary data-[state=checked]:border-brand-primary"
                />
                <span className="text-sm text-white/80">
                  <SmsConsentText linkClassName="underline hover:text-white" />
                  {smsSaving && <Loader2 className="ml-2 inline h-3.5 w-3.5 animate-spin" />}
                </span>
              </label>
              <p id="sms-preferences-help" className="text-xs text-white/40 leading-relaxed">
                {smsOptIn
                  ? 'You are subscribed. Uncheck the box or reply STOP to any message to unsubscribe at any time.'
                  : 'You are not subscribed. Checking the box saves your consent with a timestamp; you can withdraw it here or by replying STOP.'}{' '}
                We never share your mobile number with third parties for marketing.
              </p>
            </CardContent>
          </Card>
