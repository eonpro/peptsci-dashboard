  ...
  return (
    <>
      ...
      <button
        ...
        aria-expanded={open}
        className={cn(
          'fixed z-50 flex h-12 w-12 items-center justify-center rounded-2xl border border-white/15 bg-[#0a0e3a] shadow-[0_10px_35px_-10px_rgba(0,0,0,0.8)] transition-transform hover:scale-105',
